...
#include "TopDownShooterCameraManager.h"
...
ATopDownShooterPlayerController::ATopDownShooterPlayerController()
{
	...
	PlayerCameraManagerClass = ATopDownShooterCameraManager::StaticClass();
}
...
void ATopDownShooterPlayerController::BeginPlay()
{
	...
	if (SVirtualJoystick::ShouldDisplayTouchInterface() && IsLocalPlayerController())
	{
		...
		if (MobileControlsWidget)
		{
			...
			UE_LOG(LogTopDownShooter, Error, TEXT("Could not spawn mobile controls widget."));
